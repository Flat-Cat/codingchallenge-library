...
function Books() {
    ...
    //___Button goBack_____________________________________________________
    const navigate = useNavigate();
    const goBack = () => {
        navigate("/")
    }
    //___Button changeBook_____________________________________________________
    const changeBook = () => {
        navigate(`/books/update/${data.id}`)
    }
    //___Button Delete__________________________________________________________________
    ...
    const deleteBookButton = (formEvent: FormEvent) => {
        ...
        return (
            <div>
                ...
                <button className="delete is-large" name="deleteButton" onClick={deleteBookButton}></button>
